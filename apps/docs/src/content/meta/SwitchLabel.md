...
<PropsTable :data="[
  {
    'name': 'alignLabel',
    'description': '<p>Alignment of the labels: &quot;start&quot; (usually left) or &quot;end&quot; (usually right).</p>\n',
    'type': '\'start\' | \'end\'',
    'required': false
  },
  {
    'name': 'ariaInvalid',
    'description': '',
    'type': 'false | true | \'true\' | \'false\' | \'grammar\' | \'spelling\'',
    'required': false
  },
  {
    'name': 'as',
  ...
  {
    'name': 'label',
    'description': '<p>Label displayed next to the switch. It can be a string, element, or any other\nrenderable node.</p>\n',
    'type': 'string',
    'required': false
  },
  {
